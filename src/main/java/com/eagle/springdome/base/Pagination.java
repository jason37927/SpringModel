...
public class Pagination<T> implements Serializable{
    ...
    private int displayingPageLimit = 10;
    ...
    {
        return this.getDisplayingPages().get(0) != 1 ;
    }

    public boolean hasSufPages()
    {
        List<Integer> pags = this.getDisplayingPages();
        return pags.get(pags.size()-1) != maxPage ;
    }

    public List<Integer> getDisplayingPages() {
        List<Integer> displayingPages = Lists.newArrayList();
